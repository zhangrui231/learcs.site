...
To obtain the same answer in Python 3 use floored ( `//`
integer) division.
...
- _E_ xponentiation has the next highest precedence, so
...
But if the user types something other than a string of digits, you
get an error:

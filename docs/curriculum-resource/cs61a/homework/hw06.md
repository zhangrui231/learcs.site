...
Download [hw06.zip](/resource/cs61a/hw/hw06.zip). Inside the archive, you will find a file called [hw06.py](https://cs61a.org//hw/hw06/hw06.py), along with a copy of the `ok` autograder.

...
Download [hw03.zip](/resource/cs61a/hw03.zip). Inside the archive, you will find a file called [hw03.py](https://cs61a.org//hw/hw03/hw03.py), along with a copy of the `ok` autograder.
